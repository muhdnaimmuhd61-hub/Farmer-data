...
if __name__ == "__main__":
    app.run(host="0.0.0.0", port=5000, debug=True)from flask import Flask, render_template_string, request
import sqlite3
import json
...
def init_db():
    ...
    all_locations = {
        ...
        "Cross River": ["Akpabuyo","Odukpani","Akamkpa","Biase","Bekwarra","Bakassi","Calabar South","Calabar Municipal","Etung","Ikom","Obanliku","Obubra","Obudu","Ogoja","Yakuur","Yala"],
        ...
        "Ogun": ["Abeokuta North","Abeokuta South","Ado-Odo/Ota","Egbado North","Egbado South","Ewekoro","Ifo","Ijebu East","Ijebu North","Ijebu North East","Ijebu Ode","Ikenne","Imeko Afon","Ipokia","Obafemi-Owode","Odogbolu","Ogun Waterside","Remo North","Shagamu"],
...
<label>{{ 'Local Government Area (LGA)' if lang=='en' else 'Karamar Hukuma (LGA)' }}</label>
